...
<footer>
	...
	<div class="copyright copyright-wrapper">
        <div class="container">
        	<p><?php echo esc_html(get_theme_mod('vw_restaurant_lite_footer_copy',__('Copyright 2016 -','vw-restaurant-lite'))); ?> <?php vw_restaurant_lite_credit(); ?></p>
            <?php if( get_theme_mod( 'vw_restaurant_lite_hide_show_scroll',true) != '') { ?>
                ...
                if($theme_lay == 'Left'){ ?>
                  <a href="#" class="scrollup left"><i class="fas fa-long-arrow-alt-up"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'vw-restaurant-lite' ); ?></span></a>
                <?php }else if($theme_lay == 'Center'){ ?>
                  <a href="#" class="scrollup center"><i class="fas fa-long-arrow-alt-up"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'vw-restaurant-lite' ); ?></span></a>
                <?php }else{ ?>
                  <a href="#" class="scrollup"><i class="fas fa-long-arrow-alt-up"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'vw-restaurant-lite' ); ?></span></a>
                <?php }?>
            <?php }?>
        </div>
        <div class="clear"></div>
