<?php
/**
 * Class Name: Kodiak_football_sport_bootstrap_navwalker
...
if ( ! class_exists( 'WP_Bootstrap_Navwalker' ) ) {
	...
	class Kodiak_Football_Sport_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if ( 0 === strcasecmp( $item->attr_title, 'divider' ) && 1 === $depth ) {
				...
				if ( isset( $args->has_children ) && 0 === $args->has_children && $depth ) {
		...
		public static function fallback( $args ) {
			if ( current_user_can( 'edit_theme_options' ) ) {
				...
				echo '>';
				echo '<li><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" title="">' . esc_attr_e( 'Add a menu', 'kodiak-football-sport' ) . '</a></li>';
				echo '</ul>';
				if ( $container ) {
					echo '</' . esc_attr( $container ) . '>';
				}
